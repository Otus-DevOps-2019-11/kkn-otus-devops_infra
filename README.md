...
01. Создал и настроил роли app и db

02. Проверил работу ansible с ролями на stage
    окружении

03. Создал разные настройки ansible для управления
    stage и prog окружениями

04. Задал в конфиге ansible окружение stage как
    окружение по умолчанию

05. Задал настройки окружений stage и prod испоьзуя
    групповые переменные

06. Настроил переменную env для вывода информации
    об окружении при применении плейбуков

07. Реорганизовал плейбуки согласно best practices

08. Проверил работу со stage и prod окружениями
    после реорганизации

09. Установил Community-роль jdauphant.nginx

10. Настроил jdauphant.nginx для использования в
    stage и prod окружениях

11. Настроил конфигурацию terraform на открытие
    80 порта

12. Добавил вызов роли jdauphant.nginx в плейбуке
    app.yml

13. Применил плейбук site.yml для окружения stage
    и проверил что приложение теперь доступно по
    80 порту

14. Создал файл vaulk.key с произвольной строкой
    ключа. Настроил ansible на его использование

15. Добавил плейбук для создания пользователей
    users.yml

16. Создал фойлы с  данными пользователе
    credentials.yml для каждого окружения и
    зашифровал их
